 ...
 *
 */
public class ReplyMessageEntityManagerFactory extends AbstractEntityManagerFactory {

  private static final String PERSISTENCE_UNIT_NAME = "kapua-replyMessage";
   ...
   */
  private ReplyMessageEntityManagerFactory() {
   ...
   * @return not null
   */
  public static ReplyMessageEntityManagerFactory getInstance() {
    return instance;
  }
