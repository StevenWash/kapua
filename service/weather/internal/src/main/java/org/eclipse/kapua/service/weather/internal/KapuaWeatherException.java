 ...
 * 
 */
public class KapuaWeatherException extends KapuaException {
     ...
     * @param code
     */
    public KapuaWeatherException(KapuaWeatherErrorCodes code) {
        super(code);
    }
     ...
     * @param arguments
     */
    public KapuaWeatherException(KapuaWeatherErrorCodes code, Object... arguments) {
     ...
     * @param arguments
     */
    public KapuaWeatherException(KapuaWeatherErrorCodes code, Throwable cause, Object... arguments) {
     ...
     * @return
     */
    public static KapuaWeatherException internalError(String message) {
        return new KapuaWeatherException(KapuaWeatherErrorCodes.INTERNAL_ERROR, null, message);
    }
