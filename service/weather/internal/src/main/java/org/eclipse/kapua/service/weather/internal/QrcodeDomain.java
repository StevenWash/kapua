 ...
 *
 */
public class QrcodeDomain extends AbstractKapuaEntity implements Domain {

    private static final long serialVersionUID = 3782336558657796495L;

    private String name = "qrcode";
    private String serviceName = "qrcodeService";
    private Set<Actions> actions = new HashSet<>(Lists.newArrayList(Actions.write));
