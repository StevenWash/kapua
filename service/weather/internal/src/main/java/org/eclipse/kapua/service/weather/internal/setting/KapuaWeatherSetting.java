 ...
 *******************************************************************************/
package org.eclipse.kapua.service.weather.internal.setting;
 ...
 *
 */
public class KapuaWeatherSetting extends AbstractKapuaSetting<KapuaWeatherSettingKeys> {
    ...
    private static final KapuaWeatherSetting INSTANCE = new KapuaWeatherSetting();

    /**
     * Initialize the {@link AbstractKapuaSetting} with the {@link KapuaAccountSettingKeys#ACCOUNT_KEY} value.
     * 
     */
    private KapuaWeatherSetting() {
     ...
     */
    public static KapuaWeatherSetting getInstance() {
        return INSTANCE;
    }
}
