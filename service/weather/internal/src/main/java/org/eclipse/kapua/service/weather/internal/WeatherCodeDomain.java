 ...
 *
 */
public class WeatherCodeDomain extends AbstractKapuaEntity implements Domain {

    private static final long serialVersionUID = 3782336558657796495L;

    private String name = "weatherCode";
    private String serviceName = "weatherCodeService";
