...
public class AppInfoJAXBContextProvider implements JAXBContextProvider {

    private static final Logger logger = LoggerFactory.getLogger(AppInfoJAXBContextProvider.class);
