 ...
 * 
 */
public class KapuaAppInfoException extends KapuaException {


  /**
	 * 
	 */
	private static final long serialVersionUID = -5126263222346687433L;
	
 private static final String KAPUA_ERROR_MESSAGES = "kapua-appInfo-service-error-messages";
   ...
   * @param code not null
   */
  public KapuaAppInfoException(KapuaAppInfoErrorCodes code) {
        super(code);
  }
   ...
   */
  public KapuaAppInfoException(KapuaAppInfoErrorCodes code, Object... arguments) {
   ...
   * @return not null
   */
  public static KapuaAppInfoException internalError(String message) {
    return new KapuaAppInfoException(KapuaAppInfoErrorCodes.INTERNAL_ERROR, null, message);
  }
