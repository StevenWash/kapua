 ...
 * 
 */
public class KapuaWxAccountException extends KapuaException {

  private static final long serialVersionUID = 6422745329878392484L;

  private static final String KAPUA_ERROR_MESSAGES = "kapua-wxaccount-service-error-messages";
   ...
   * @param code not null
   */
  public KapuaWxAccountException(KapuaAppWxAccountCodes code) {
        super(code);
  }
   ...
   */
  public KapuaWxAccountException(KapuaAppWxAccountCodes code, Object... arguments) {
   ...
   * @return not null
   */
  public static KapuaWxAccountException internalError(String message) {
    return new KapuaWxAccountException(KapuaAppWxAccountCodes.INTERNAL_ERROR, null, message);
  }
