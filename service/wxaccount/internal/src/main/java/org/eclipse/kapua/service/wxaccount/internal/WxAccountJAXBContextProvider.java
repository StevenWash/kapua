...
public class WxAccountJAXBContextProvider implements JAXBContextProvider {

  private static final Logger logger = LoggerFactory.getLogger(WxAccountJAXBContextProvider.class);
