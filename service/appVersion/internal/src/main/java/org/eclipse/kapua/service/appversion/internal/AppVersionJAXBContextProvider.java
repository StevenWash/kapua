...
public class AppVersionJAXBContextProvider implements JAXBContextProvider {

  private static final Logger logger = LoggerFactory.getLogger(AppVersionJAXBContextProvider.class);
